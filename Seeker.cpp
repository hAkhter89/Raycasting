...
void Seeker::updateAlert(bool newAlert) { alert = newAlert; }

void Seeker::updateRange(bool newInRange) { inRange = newInRange; }

std::string Seeker::getType() const { return "Seeker"; }
